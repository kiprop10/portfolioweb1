...
export default {
  ...
  assets: {
    ...
    'blog/index.html': {size: 46583, hash: '44b194dadc116e9a1443dbebc66c88864e66baebe44ffe1d0478b76a600d885f', text: () => import('./assets-chunks/blog_index_html.mjs').then(m => m.default)},
