...
export default {
  ...
  assets: {
    ...
    'blog/index.html': {size: 46566, hash: 'dfe0bc5897b9f5cc059bfd8e805568ac113e211ea4fd040876349a49d4e264bf', text: () => import('./assets-chunks/blog_index_html.mjs').then(m => m.default)},
