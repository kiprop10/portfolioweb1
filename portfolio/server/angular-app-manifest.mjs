...
export default {
  ...
  assets: {
    ...
    'blog/index.html': {size: 46566, hash: '83cdb59793ca25156db7e9201e8d42a43b931d2a08ef977e64f024f1f439d73f', text: () => import('./assets-chunks/blog_index_html.mjs').then(m => m.default)},
