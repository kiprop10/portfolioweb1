...
export default {
  ...
  assets: {
    ...
    'blog/index.html': {size: 46566, hash: 'd5cd77da469b3d2dde87988f93185d1423ff3f83ac88cc21724f02d1e33bc55f', text: () => import('./assets-chunks/blog_index_html.mjs').then(m => m.default)},
