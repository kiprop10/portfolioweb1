...
export default {
  ...
  assets: {
    ...
    'blog/index.html': {size: 46583, hash: '345e70226cfe716da5bd44c3e7fe2261f67d547dcefc77efb1657a5b1f20fe81', text: () => import('./assets-chunks/blog_index_html.mjs').then(m => m.default)},
