...
export default {
  ...
  assets: {
    ...
    'blog/index.html': {size: 46583, hash: 'b5588e9401ede53156b8b2f392f9028f30249b434db9f0a3aff99a3f80d75321', text: () => import('./assets-chunks/blog_index_html.mjs').then(m => m.default)},
